    ...
    while play_game:
        ...
        match game_number:
            case 1:
                ...
                print(f'\nPlaying Tic Tac Toe Minimax vs {p2_agent_name}')
            ...
            case 2:
                ...
                print(f'\nPlaying {game_type} Minimax vs {p2_agent_name}')
            ...
            case 4:
                ...
                print(f'\nPlaying {game_type} Minimax vs {p2_agent_name} vs {p2_agent_name}')
            ...
            case 6:
                game_stat = None
                old_name = p2_agent_name
                playing_random = not playing_random
                p2_agent_name = 'Random' if playing_random else 'Minimax'
                print(f'\n\nSwapped Player 2: {old_name} → {p2_agent_name}\n\n')
            case _:
                game_stat = None
